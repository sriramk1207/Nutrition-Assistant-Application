...
app.config['MAIL_USERNAME'] = 'ganesanlakz007@gmail.com'
app.config['MAIL_PASSWORD'] = 'uoyokfnygvpwajxu'
...
def verify():
    if request.method == 'POST':
        ...
        if account:
           ...
           ibm_db.bind_param(stmt, 1, email1)
           ibm_db.execute(stmt)
           msg = Message('NUTRITION ASSISTANT',sender ='ganesanlakz007@gmail.com',recipients = [email1])
